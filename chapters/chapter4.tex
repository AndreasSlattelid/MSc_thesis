...
A zero coupon bond (ZCB) \nomenclature{ZCB}{Zero Coupon Bond} with a maturity $T$ guarantees the holder one dollar to be paid out at maturity $T$. We denote the time $t$ price of the zero coupon bond as $P(t,T)$
\end{definition}
...
\begin{definition}[\textbf{LIBOR-rate}]
 We define the LIBOR-rate \nomenclature{LIBOR}{London Interbank Offered Rate}
